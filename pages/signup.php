  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      ...
      <a class="navbar-brand" href="#">
        <!-- <img src="assets/png-branch.png" alt="" width="40" class="d-inline-block align-text-top"> -->
      </a>
            ...
            <div class="box-1">
              ...
              <form action="../includes/signup.inc.php" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="fullName" aria-describedby="nameHelp" name="fullName">
                </div>
                <div class="mb-3">
